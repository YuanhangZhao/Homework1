...
app.layout = html.Div([
    ...
    html.Div(
        [
            ...
            dcc.Input(id='currency-pair',value = 'AUDCAD')
        ],
    ...
    html.Div(id='output-div', children='press submit to update!'),
    html.Div([
    ...
    dcc.Input(id='trade_currency', type='text', value='EURUSD', style={'display': 'inline-block'}),
